...
Quand c’est utile :
  ...
  dw ask "question"                  Lire des faits cités ou une abstention explicite
...
Continuité du projet :
  ...
  dw decision confirm|reject|retire|supersede|show <id>
                                       Réviser la mémoire (aussi objective/invariant/failed-approach)
