...
class MemoryQuestionTests(unittest.TestCase):
    ...
    def test_attached_zone_offset_and_zulu_clocks_are_clock_qualifiers(self):
        phrases=('1200Z','0930Z','T1200Z','120000Z','12:00EST','1200EST','3pmEST','3PMEST','12hEET',
                 ...
                 '12 Chile/Continental','12 America/Argentina/Buenos_Aires','12 Etc/GMT+5','12 NZ-CHAT',
                 '12 W-SU','12 GB-Eire','12 Japan','12 Turkey','12 Zulu','12 UCT','3pm Hongkong','12 GMT+0')
        ...
        for index,label in enumerate(('v1200Z','build_1200EST','release-09-21T120000Z','rev12hEET',
                                      ...
                                      'US/Eastern region','12 GB volume','Japan office','12 japan tea',
