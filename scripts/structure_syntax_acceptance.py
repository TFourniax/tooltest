...
with tempfile.TemporaryDirectory(prefix='dw-syntax-installed-') as td:
    ...
    response = values[0]
    assert response['coverage'] == {'files': 7, 'parsed': 5, 'unparsed': 1, 'unsupported': 1}, response
...
print('INSTALLED SYNTAX ACCEPTANCE PASS: actual pinned JS/TS/Go/Rust, Unicode-compatible JSON, source hashes, FR/EN, unparsed and unsupported coverage; MACHINE')
