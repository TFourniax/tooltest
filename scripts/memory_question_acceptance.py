...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='dw-question-acceptance-') as temporary:
        ...
        relative_periods=('this weekend','this spring','this summer','this autumn','this fall','this winter',
                          ...
                          '12 EET','12 EEST','12 WET','12 WEST','12 SAST','12 HKT','12 WIB','12 ChST','12 AHST','12 HKST','12 YST','12 YDT','12 +03','9 -0330','1200Z','12:00EST','3pmEST','noonEST','1200hrs','1200+03','12h30Z','3pmZ','12h30+02','12 EST/PST','12EST-5','12 hrs-service')
